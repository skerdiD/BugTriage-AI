...
export function ProductPreview() {
  return (
    <section
      id="product-preview"
      className="render-deferred scroll-mt-24 border-t border-white/[0.07] bg-white/[0.012] px-5 py-16 sm:px-6 md:py-24"
    >
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-balance text-3xl font-semibold tracking-[-0.035em] text-white md:text-5xl">
            Start debugging with the context already organized.
          </h2>
        ...
        <div className="group mt-12 rounded-[30px] border border-white/10 bg-[linear-gradient(135deg,rgba(139,92,246,0.08),rgba(8,145,178,0.07),rgba(15,23,42,0.72))] p-3 shadow-[0_34px_110px_-72px_rgba(0,0,0,0.96)] transition duration-500 hover:border-violet-200/20">
